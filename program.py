...
if count>=17:
    ...
    Eenergy=(C2*ans61.get())+(C4*ans62.get())+(C6*ans71.get())+(C8*ans73.get())+(C10*ans72.get())-(ans87.get()*C2)-(ans88.get()*C4)

    # calculation for total Co2 of fossile fuels use
    Fco2=(Fo1*ans91.get())+(Fo3*ans92.get())+(Fo7*ans94.get())+(Fo9*ans95.get())
    ...
    Sco2=(S1*ans141.get())+(S3*ans142.get())+(S5*ans143.get())+(S7*ans144.get())+(S9*ans145.get())+(S11*ans146.get())

    # calculation for total energy of substrates
    Senergy=(S2*ans141.get())+(S4*ans142.get())+(S6*ans143.get())+(S8*ans144.get())+(S10*ans145.get())+(S12*ans146.get())

    # calculation for total Co2 of water
    Wco2= (W1*ans151.get())

    # calculation for total energy of water
    Wenergy = (W2*ans151.get())

    # calculation for total Co2 of pesticides
    Pco2 = (P1*ans161.get())+(P3*ans162.get())+(P5*ans163.get())+(P7*ans164.get())+(P9*ans165.get())

    # calculation for total energy of pesticides
    Penergy = (P2*ans161.get())+(P4*ans162.get())++(P6*ans163.get())++(P8*ans164.get())+(P10*ans165.get())

    # calculation for total Co2 of transport
    Tco2= (T1* ans201.get())+(T3*ans202.get())+(T5*ans203.get())

    # calculation for total energy of transport
    Tenergy= (T2* ans201.get())+(T4*ans202.get())+(T6*ans203.get())
