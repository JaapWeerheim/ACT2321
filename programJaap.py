...
start_button = Button(frame0, text='Start', command=start, font=12)
...
sel_renew_entry = Entry(frame10, width=10, textvariable=ans87)
sel_renew_entry.grid(row=0, column=1)
Label(frame10, text='Selling non-renewable(kWh)').grid(row=1, column=0, sticky=W, padx=5)
sel_grey_entry = Entry(frame10, width=10, textvariable=ans88)
sel_grey_entry.grid(row=1, column=1)
...
amnit_entry = Entry(frame14, width=10, textvariable=ans121)
amnit_entry.grid(row=1, column=1)
Label(frame14, text='Calciumammoniumnitrate').grid(row=2, column=0, padx=5, sticky=W)
calam_entry = Entry(frame14, width=10, textvariable=ans122)
calam_entry.grid(row=2, column=1)
Label(frame14, text='Ammoniumsulphate').grid(row=3, column=0, padx=5, sticky=W)
amsul_entry = Entry(frame14, width=10, textvariable=ans123)
amsul_entry.grid(row=3, column=1)
Label(frame14, text='Triplesuperphosphate').grid(row=4, column=0, padx=5, sticky=W)
triphos_entry = Entry(frame14, width=10, textvariable=ans124)
triphos_entry.grid(row=4, column=1)
Label(frame14, text='Single super phosphate').grid(row=5, column=0, padx=5, sticky=W)
sisu_entry = Entry(frame14, width=10, textvariable=ans125)
sisu_entry.grid(row=5, column=1)
Label(frame14, text='Ammonia').grid(row=6, column=0, padx=5, sticky=W)
ammon_entry = Entry(frame14, width=10, textvariable=ans126)
ammon_entry.grid(row=6, column=1)
Label(frame14, text='Limestone').grid(row=7, column=0, padx=5, sticky=W)
lim_entry = Entry(frame14, width=10, textvariable=ans127)
lim_entry.grid(row=7, column=1)
Label(frame14, text='NPK 15-15-15').grid(row=8, column=0, padx=5, sticky=W)
npk_entry = Entry(frame14, width=10, textvariable=ans128)
npk_entry.grid(row=8, column=1)
Label(frame14, text='Phosphoric acid').grid(row=9, column=0, padx=5, sticky=W)
phos_entry = Entry(frame14, width=10, textvariable=ans131)
phos_entry.grid(row=9, column=1)
Label(frame14, text='Mono-ammonium phosphate').grid(row=10, column=0, padx=5, sticky=W)
mon_entry = Entry(frame14, width=10, textvariable=ans132)
mon_entry.grid(row=10, column=1)
...
list_ans = [farm_name, ans1, v, ans61, ans62, ans71, ans72, ans73, ans87,
            ans88, ans890, ans91, ans92, ans94, ans95, ans121, ans122, ans123, ans124, ans125, ans126, ans127, ans128,
            ans131, ans132, ans133, ans141, ans142, ans143, ans144, ans145, ans146, ans147, ans151, ans152,
            ans161, ans162, ans163, ans164, ans165, ans166, ans171, ans172, ans201,
            ans202, ans204]

# This list is created to remove zero's from the entries.
list_zeros= [ans61, ans62, ans71, ans72, ans73, ans87, ans88, ans890, ans91, ans92, ans93, ans94, ans95, ans121,
             ans122, ans123, ans124, ans125, ans126,  ans127, ans128, ans131, ans132, ans133, ans141, ans142, ans143,
             ans144, ans145, ans146, ans147, ans151, ans152, ans161, ans162, ans163, ans164, ans165, ans166, ans171,
             ans172, ans173, ans201, ans202, ans203, ans204]
