...
SellRenLabel = Label(frame_sell_renewable, text='Selling renewable').grid(row=0, column=0, sticky=W, padx=5)
...
SellNonrenLabel = Label(frame_sell_renewable, text='Selling non-renewable').grid(row=1, column=0, sticky=W, padx=5)
...
am_label = Label(frame_fertilizer_use, text='Ammoniumnitrate').grid(row=1, column=0, padx=5, sticky=W)
...
ca_label = Label(frame_fertilizer_use, text='Calciumammoniumnitrate').grid(row=2, column=0, padx=5, sticky=W)
...
amsu_label = Label(frame_fertilizer_use, text='Ammoniumsulphate').grid(row=3, column=0, padx=5, sticky=W)
...
tri_label = Label(frame_fertilizer_use, text='Triplesuperphosphate').grid(row=4, column=0, padx=5, sticky=W)
...
ssp_label = Label(frame_fertilizer_use, text='Single super phosphate').grid(row=5, column=0, padx=5, sticky=W)
...
ammonia_label = Label(frame_fertilizer_use, text='Ammonia').grid(row=6, column=0, padx=5, sticky=W)
...
lim_label = Label(frame_fertilizer_use, text='Limestone').grid(row=7, column=0, padx=5, sticky=W)
...
npk_label = Label(frame_fertilizer_use, text='NPK 15-15-15').grid(row=8, column=0, padx=5, sticky=W)
...
pho_label = Label(frame_fertilizer_use, text='Phosphoric acid').grid(row=9, column=0, padx=5, sticky=W)
...
mono_label = Label(frame_fertilizer_use, text='Mono-ammonium phosphate').grid(row=10, column=0, padx=5, sticky=W)
...
roc_label = Label(frame_substrate_use, text='Rockwool').grid(row=1, column=0, padx=5, sticky=W)
...
per_label = Label(frame_substrate_use, text='Perlite').grid(row=2, column=0, padx=5, sticky=W)
...
coc_label = Label(frame_substrate_use, text='Cocofiber').grid(row=1, column=2, padx=5, sticky=W)
...
hem_label = Label(frame_substrate_use, text='Hemp fiber').grid(row=2, column=2, padx=5, sticky=W)
...
pea_label = Label(frame_substrate_use, text='Peat').grid(row=3, column=0, padx=5, sticky=W)
...
peaM_label = Label(frame_substrate_use, text='Peat Moss').grid(row=3, column=2, padx=5, sticky=W)
...
water_label = Label(frame_water_use, text='Tap water').grid(row=1, column=0, padx=5, sticky=W)
...
atr_label = Label(frame_pesticide_use, text='Atrazine').grid(row=1, column=0, padx=5, sticky=W)
...
gly_label = Label(frame_pesticide_use, text='Glyphosphate').grid(row=2, column=0, padx=5, sticky=W)
...
met_label = Label(frame_pesticide_use, text='Metolachlor').grid(row=3, column=0, padx=5, sticky=W)
...
her_label = Label(frame_pesticide_use, text='Herbicide').grid(row=4, column=0, padx=5, sticky=W)
...
ins_label = Label(frame_pesticide_use, text='Insectiside').grid(row=5, column=0, padx=5, sticky=W)
...
van_label = Label(frame_transport, text='Van').grid(row=1, column=0, padx=40, sticky=W)
...
tru_label = Label(frame_transport, text='Truck').grid(row=2, column=0, padx=40, sticky=W)
